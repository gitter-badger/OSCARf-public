...
#oscar will automatically try to import first. On exception it will alert the user
...
try:
	...
	print "[+]ERROR: Could not detect an active internet connection. An internet connection is required to use OSCAR-F"
	exit()

import csv, sys, json, os, time, re
...
#----Why 2 twitter libs?----#
#The auth for the twitter lib is nicer as it can create an auth file to read from.
#the twitter auth will also open a browser window where you will accept the app to use
#your twitter account. Read and Write is what it requires. When accepted, you will get a
#pin to enter into the application. You will not be prompted for a pin after getting a
#token.
#----END----#
