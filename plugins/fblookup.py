...
def FBUsr():
  ...
  while myCounter <= people:
    ...
    try:
      ...
      jsonResponse = json.load(data)
      print "\n","\n","\n"
      #Try and set the f_link var to the link section of json data..If not found, then
      #the link will just be something null or a message
      try:
      ...
      if dlprof == 'y' or dlprof == 'Y':
        ...
        if view == "y" or view == "Y":
          try:
            ...
            print 'There was an error opening the file! Is the PIL module installed??'
            pass
        else:
          pass
      else:
      ...
      #print "There was an error processing your request - Could be how the user setup permissions"
      pass
  return
